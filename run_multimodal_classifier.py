...
import resnets.resnet as resnet
from resnets.resnet_utils import myResnet
...
def main():
    ...
    parser.add_argument("--data_dir",
                        ...
                        default='../IJCAI2019_data/twitter2015',
                        type=str,
                        required=False,
    ...
    parser.add_argument('--fine_tune_cnn',default = True, action='store_true', help='fine tune pre-trained CNN if True')
    parser.add_argument('--resnet_root', default='./resnets', help='path the pre-trained cnn models')
    ...
    parser.add_argument('--bertlayer', default = True,action='store_true', help='whether to add another bert layer')
    ...
    if args.local_rank == -1 or args.no_cuda:
        device = torch.device("cuda:5" if torch.cuda.is_available() and not args.no_cuda else "cpu")
        #
        n_gpu = 1
    else:
